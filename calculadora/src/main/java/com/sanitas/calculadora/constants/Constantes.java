...
public class Constantes {
    ...
    // Constantes para la operación sumar
    public static final String OPERACION_SUMAR = "SUMAR";

    // Constantes para la operación resta
    public static final String OPERACION_RESTA = "RESTA";
